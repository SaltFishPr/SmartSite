<template>
    <div>
        ...
        >
            ...
            <vxe-table-column field="clientName" title="委托方名称"></vxe-table-column>
            <vxe-table-column field="clientDescription" title="委托方描述"></vxe-table-column>
            <vxe-table-column title="操作" width="100" show-overflow>
                <template v-slot="{ row }">
                    <vxe-button type="text" title="编辑" icon="fa fa-edit" @click="clientEdit(row)"></vxe-button>

                    <vxe-button type="text" title="删除" icon="fa fa-trash-o" @click="clientDelete(row)"></vxe-button>
                </template>
            </vxe-table-column>
        </vxe-table>
                ...
                <el-row type="flex" justify="center">
                    <vxe-toolbar>
                        <template v-slot:buttons>
                            <vxe-button icon="fa fa-plus" @click="clientAdd()">新增委托方</vxe-button>
                        </template>
                    </vxe-toolbar>
                </el-row>
            </el-col>
        ...
        >
            <template v-slot>
                <vxe-form :data="client" :rules="formRules" title-align="right" title-width="100" @submit="submitEvent">
                    <vxe-form-item title="委托方编号" field="clientId" span="24" :visible="selectAction">
                        <template v-slot>
                            <vxe-input
