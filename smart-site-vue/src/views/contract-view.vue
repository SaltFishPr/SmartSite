<template>
    <div>
        ...
        >
            ...
            <vxe-table-column field="contractDescription" title="合同描述"></vxe-table-column>

            <vxe-table-column title="操作" width="100" show-overflow>
                <template v-slot="{ row }">
                    <vxe-button type="text" title="编辑" icon="fa fa-edit" @click="contractEdit(row)"></vxe-button>

                    <vxe-button type="text" title="删除" icon="fa fa-trash-o" @click="contractDelete(row)"></vxe-button>
                </template>
            </vxe-table-column>
        </vxe-table>
            ...
            <el-col :span="24">
                <el-row type="flex" justify="center">
                    <vxe-pager
                        ...
                        :total="contractPage.totalResult"
                ...
                <el-row type="flex" justify="center">
                    <vxe-toolbar>
                        <template v-slot:buttons>
                            <vxe-button icon="fa fa-plus" @click="contractAdd()">新增合同</vxe-button>
                        </template>
                    </vxe-toolbar>
                </el-row>
            </el-col>
        ...
        >
            <template v-slot>
                <vxe-form
                    ...
                    @submit="submitEvent"
                >
                    <vxe-form-item title="合同编号" field="contractId" span="24" :visible="selectAction">
                        <template v-slot>
                            <vxe-input
                    ...
                    <vxe-form-item title="创建时间" field="createTime" span="24" :visible="selectAction">
                        <template v-slot>
                            <vxe-input
                    ...
                    <vxe-form-item align="center" span="24" titleAlign="left">
                        <template v-slot>
                            <vxe-button type="submit" status="primary" @click="submitEvent">提交</vxe-button>
                        </template>
                    </vxe-form-item>
                </vxe-form>
            </template>
...
export default {
    ...
    methods: {
        ...
        handlePageChange({ currentPage, pageSize }) {
            //分页功能
            this.contractPage.currentPage = currentPage;
            this.contractPage.pageSize = pageSize;
            this.contractListGet();
        ...
        contractListGet() {
            ...
            service({
                ...
                data: {
                    page: this.contractPage.currentPage,
                    size: this.contractPage.pageSize,
                    searchKey: this.contractPage.searchKey
                ...
                .then(({ data }) => {
                    ...
                    this.contractList = data.resultList;
                    this.contractPage.totalResult = data.resultTotal;
            ...
            this.contractList = [
                {
                    contractId: 1, //合同编号
                    clientId: 1, //委托方ID
                    contractDescription: "合同描述1" //委托方描述
                },
                {
                    contractId: 2,
                    clientId: 2,
                    contractDescription: "合同描述2"
                },
                {
                    contractId: 3,
                    clientId: 2,
                    contractDescription: "合同描述3"
                },
                {
                    contractId: 4,
                    clientId: 6,
                    contractDescription: "合同描述4"
                },
                {
                    contractId: 5,
                    clientId: 7,
                    contractDescription: "合同描述5"
                },
                {
                    contractId: 6,
                    clientId: 2,
                    contractDescription: "合同描述6"
                }
            ];
            this.contractPage = {
                currentPage: 1,
