    ...
    <div>
        ...
        >
            ...
            <vxe-table-column title="操作" wIdth="100" show-overflow>
                <template v-slot="{ row }">
                    <vxe-button type="text" title="编辑" icon="fa fa-edit" @click="groupEdit(row)"></vxe-button>

                    <vxe-button type="text" title="删除" icon="fa fa-trash-o" @click="groupDelete(row)"></vxe-button>
                </template>
            </vxe-table-column>
        </vxe-table>
        ...
        >
            <template v-slot>
                <vxe-form :data="group" :rules="formRules" title-align="right" title-wIdth="100" @submit="submitEvent">
