<template>
    <div>
        <el-tree :data="checkSystemTree" node-key="systemId" default-expand-all :expand-on-click-node="false">
            <el-row slot-scope="{ node, data }" type="flex">
                ...
                <el-col :offset="4">
                    <el-button type="text" size="mini" @click="() => update(node, data)" icon="el-icon-edit">
                    </el-button>
                </el-col>
                <el-col :offset="4">
