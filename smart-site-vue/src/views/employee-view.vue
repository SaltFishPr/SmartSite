<template>
    <div>
        ...
        >
            ...
            <vxe-table-column field="employeeGroup" title="员工组别"></vxe-table-column>

            <vxe-table-column title="操作" width="100" show-overflow>
                <template v-slot="{ row }">
                    <vxe-button type="text" title="编辑" icon="fa fa-edit" @click="employeeEdit(row)"></vxe-button>

                    <vxe-button type="text" title="删除" icon="fa fa-trash-o" @click="employeeDelete(row)"></vxe-button>
                </template>
            </vxe-table-column>
        </vxe-table>
                ...
                <el-row type="flex" justify="center">
                    <vxe-toolbar>
                        <template v-slot:buttons>
                            <vxe-button icon="fa fa-plus" @click="employeeAdd()">新增员工</vxe-button>
                        </template>
                    </vxe-toolbar>
                </el-row>
            </el-col>
        ...
        >
            <template v-slot>
                <vxe-form
                    ...
                    @submit="submitEvent"
                >
                    <vxe-form-item title="员工编号" field="employeeId" span="24" :visible="selectAction">
                        <template v-slot>
                            <vxe-input
                    ...
                    <vxe-form-item title="员工组别" field="employeeGroup" span="24" :visible="selectAction">
                        <template v-slot>
                            <vxe-input
